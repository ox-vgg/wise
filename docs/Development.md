...
- This project uses [pre-commit](https://pre-commit.com/) - make sure you install the hooks using `pre-commit install --install-hoks` (after you clone and install the dev dependencies) in your repo

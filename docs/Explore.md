...
```bash
FEATURE_EXTRACTOR_CONFIG='{"transformers/owlv2/google/owlv2-large-patch14-ensemble":{"objectness_threshold":0.13}}' CUDA_VISIBLE_DEVICES=0 python extract-features.py \
...
# Manually review the face clusters and set their status to "Reviewed"
...
# TODO: Enable visibility of facets in projects served using serve.py
```

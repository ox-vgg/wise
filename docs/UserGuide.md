...
- For more details on the options available, run `wise extract-features --help`
...
- For more details on the options available, run `wise create-index --help`
...
```bash
wise serve --project-dir wise-projects/Kinetics-6/
```
...
- For more details on the options available, run `wise serve --help`

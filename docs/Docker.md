...
docker compose run --rm -it wise extract-features --project-dir "${WISE_PROJECT}" ...
docker compose run --rm -it wise create-index --project-dir "${WISE_PROJECT}" ...
docker compose run --rm -it wise serve --project-dir "${WISE_PROJECT}" ...
```
...
```bash
export WISE_PROJECT="projects/PROJECT_NAME"
wise extract-features --project-dir "${WISE_PROJECT}" ...
wise create-index --project-dir "${WISE_PROJECT}" ...
wise serve --project-dir "${WISE_PROJECT}" ...
```

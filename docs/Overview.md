 ...
 *src/inference.py contains everything related to the OpenCLIP model
   ...
   - extract_image_features() takes in a list of PIL images, or a batch of preprocessed images in the form of a tensor, and returns a list of objects holding the features/embeddings vectors as a numpy arrays as well as metadata specific to each feature extractor.
